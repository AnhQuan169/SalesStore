                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/update-brand/'.$edit_brand->brand_id)}}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên thương hiệu</label>
                                <input data-validation="length" data-validation-length="min1" data-validation-error-msg="Hãy điền tên thương hiệu sản phẩm" value="{{$edit_brand->brand_name}}" name="brand_name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Tên thương hiệu sản phẩm">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Mô tả thương hiệu</label>
                                <textarea style="resize: none" rows="5" name="brand_desc" type="password" class="form-control" id="ckeditor8" placeholder="Mô tả thương hiệu">{{$edit_brand->brand_desc}}
                                </textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tình trạng</label>
