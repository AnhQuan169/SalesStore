          ...
          @foreach ($all_brand as $key => $brand_pro)
            <tr>
              ...
              <td>
                ...
                <a onclick="return confirm('Bạn có chắc chắn muốn xoá thương hiệu sản phẩm này?')" href="{{URL::to('/delete-brand/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
